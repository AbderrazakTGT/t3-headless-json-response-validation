 ...
 *
 * ❌ Fixtures CSV gitignorées — générées localement (generate_fixtures.sh)
 * ❌ Snapshots gitignorés (générés localement)
 * ✅ Travail hors-ligne : generate_fixtures.sh (zéro connexion réseau)
 */
abstract class AbstractHeadlessTestCase extends FunctionalTestCase
{
    ...
    // =========================================================================
    // Fixtures CSV
    // Gitignorées — générées localement par generate_fixtures.sh ou extract_and_anonymize.sh
    // =========================================================================
    ...
    // =========================================================================
    // JSON Schema — partiels $ref (dans Git — aucune donnée)
    // =========================================================================
