...
# Lancer un seul test
# la classe PageWithContentTest hérite de la classe AbstractHeadlessTestCase 
# si la varaible d'env UPDATE-SNAPSHOT=1 il génére un neww snapshot sinon, ça sera une comparaison
vendor/bin/phpunit \
  -c typo3/sysext/core/Build/FunctionalTests.xml \
  Tests/Functional/Headless/PageWithContentTest.php

# Vérifier les snapshots sans lancer PHPUnit (à revoir si on a besoin de ça )
