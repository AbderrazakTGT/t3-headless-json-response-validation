 ...
 *
 * ✅ Fixtures dans Git : Tests/Fixtures/Database/${scenario}/
 ...
 *   102 → admin    → "password"
 *
 * ✅ Fixtures dans Git : Tests/Fixtures/Database/page_protected/
 */
...
echo "  1. Les fixtures sont déjà dans Git (ou generate_fixtures.sh)"
